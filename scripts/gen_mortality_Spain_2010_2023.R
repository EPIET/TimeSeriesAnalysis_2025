...
heading <- "------------------------------------------------------------------------------------
 ...
 What: Read raw file with number of deaths per week in Spain, total and per sex; 
        ...
        One object with 2010-2019, and another with only 2020, and another 2010-2023.
...
project.path <- "C:/Users/skuhlmannberenzon/OneDrive - ECDC/Documents/ECDC fellowship/TSA 2025"
...
save(mortagg, file=file.path(data.path, "mortagg2.Rdata"))
print(summary(mortagg))

save(mort2020, file=file.path(data.path, "mortagg2020.Rdata"))
print(summary(mort2020))


save(mort2010_2023, file=file.path(data.path, "mortagg2010_2023.Rdata"))
print(summary(mort2010_2023))
