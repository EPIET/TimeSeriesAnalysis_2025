...
#mortagg <- import(here("data", "mortagg.dat"))
...
model. This is done by adding a term called offset(). The parameter beta for 
population will be forced to be 1, in other words, it will not affect the 
outcome. 
