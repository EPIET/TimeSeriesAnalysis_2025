...
`{r: task-4-4-IRR-trend-pop} mort_poissontrend_pop %>%    gtsummary::tbl_regression(     exponentiate = TRUE,     estimate_fun = ~style_number(.x, digits = 4)   )`
...
Carry out the same analysis for men and women. Do you see differences between the two?
